			...
			<form id="seach" name="search" action="{{ lurl(trans('routes.v-search', $attr), $attr) }}" method="GET">
				<div class="row m-0">
					...
					<div class="col-xl-4 col-md-4 col-sm-12 col-xs-12">
						...
						<input name="q" class="form-control keyword has-icon" type="text" placeholder="{{ t('What?') }}" value="{{ $keywords }}" title="" data-placement="bottom"
							   data-toggle="tooltip" type="button"  data-original-title="{{ t('car_searce')  }}">
					</div>
