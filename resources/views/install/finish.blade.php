...
@section('content')
    ...
    <h3 class="title-3 text-success">
        <i class="icon-check"></i> Congratulations, you've successfully installed Theqqa (Classified Ads Web Application)
    </h3>
	...
	<br><br>
    If you facing any issue, please visit our <a class="text-bold" href="http://support." target="_blank">Help Center</a>.
    <br><br>
    Thank you for chosing Theqqa. - <a class="text-bold" href="http://www." target="_blank"></a>
