        ...
        <div class="container">
            ...
            <div class="navbar-identity">
                ...
                <a href="{{ lurl('/') }}" class="navbar-brand logo logo-title">
                    ...
                    @else
                        <img src="{{ asset('images/logo-en.png') . getPictureVersion()  }}"
                             alt="{{ strtolower(config('settings.app.app_name')) }}" class="tooltipHere main-logo"
                             title=""
                             data-placement="bottom"
                             data-toggle="tooltip"
            ...
            <div class="navbar-collapse collapse">
                ...
                <!-- Start - Services Menu - ProCerw -->
                    <li class="nav-item dropdown no-arrow">
                        <a href="#" class="dropdown-toggle nav-link btn btn-block btn-border btn-post btn-add-listing"
                           data-toggle="dropdown"
                           data-target="#serviceMenuDropdown" id="services-btn">
                            {{--<img class="hidden-sm" src="../images/car-services.png"  width="20" height="20">--}}
                            <span>{{ t('services_title') }}</span>
                            <i class="icon-down-open-big fa hidden-sm"></i>
                        </a>
                        <ul id="serviceMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/checking') }}">
                                    <img src="{{ asset('images/check-light.png') }}"
                                         width="20"> {{ t('checking_title') }}
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/maintenance') }}">
                                    <img src="{{ asset('images/maintenance-light.png') }}"
                                         width="20"> {{ t('maintenance_title') }}
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/ownership') }}">
                                    <img src="{{ asset('images/owner-light.png') }}"
                                         width="20"> {{ t('ownership_title') }}
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/shipping') }}">
                                    <img src="{{ asset('images/shipping-light.png') }}"
                                         width="20"> {{ t('shipping_title') }}
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/mogaz') }}">
                                    <img src="{{ asset('images/mogaz-light.png') }}" width="20"> {{ t('mogaz_title') }}
                                </a>
                            </li>
                            <li class="dropdown-item">
                                <a href="{{ lurl('contactfor/estimation') }}">
                                    <img src="{{ asset('images/estimate-light.png') }}" width="20"> {{ t('estimation title') }}
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- End - Services Menu - ProCerw -->
