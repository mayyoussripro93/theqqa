...
if (
	...
	$colClass1 = 'col-lg-3 col-md-6 col-sm-6 col-xs-12';
	$colClass2 = 'col-lg-3 col-md-6 col-sm-6 col-xs-12';
	$colClass3 = 'col-lg-2 col-md-6 col-sm-6 col-xs-12';
	$colClass4 = 'col-lg-4 col-md-6 col-sm-6 col-xs-12';
} else {
				...
				@if (!config('settings.footer.hide_links'))
					<div class="{{ $colClass1 }}">
						<div class="footer-col">
							...
							<!-- Start - Heading Line - ProCrew -->
							<div class="heading-line"></div>
							<!-- End - Heading Line - ProCrew -->
...
{{--						)--}}
						<div class="{{ $colClass4 }}">
							...
							<p style="font-size:20px;"><i class="fa fa-phone" style="font-size: 18px; color: #ad891d;"></i> 0551166575</p>
							<p style="font-size: 16px;"><i class="fa fa-map-pin" style="font-size: 20px; color: #ad891d;"></i> 4410 طريق الدمام - حي المؤنسية - 13253 - الرياض - المملكة العربية السعودية</p>
						</div>
{{--					@endif--}}
				...
				<div class="col-xl-12">
					...
					<div class="copy-info text-center">
						...
						@if (!config('settings.footer.hide_powered_by'))
							...
							@else
								{{ t('Powered by') }} <a href="http://www.procrew.pro" title="ProCrew">ProCrew</a>.
							@endif
						@endif
					</div>
				</div>
