									...
									<tr>
										...
										<td>
											<div style="word-break:break-all;">
												...
												<strong>{{ t('Started by') }}:</strong>&nbsp;{{ str_limit($conversation->from_name ?? '--' , 50) }} <span class="btn-success msg-badge">{{ $from_user_type->name ?? '--' }}</span><br>
												<strong>{{ t('End to') }}:</strong>&nbsp;{{ str_limit($conversation->to_name  ?? '--' , 50) }} <span class="btn-success msg-badge">{{ $to_user_type->name ?? '--' }}</span>
