...
@if (isset($posts) and count($posts) > 0)
    ...
    {{--<div class="row flex">--}}
    {{--<div class="col-md-2 col-sm-12 col-xs-12 text-left ad">--}}
    {{--<img src="images/ad-4.jpg" class="ad-md">--}}
    {{--<img src="https://s0.2mdn.net/6232239/Cart-Abandoners-728x90.jpg" class="ad-sm">--}}
    {{--</div>--}}
    {{--<div class="col-md-8 col-sm-12">--}}
    {{--<!-- End - Ads Section - ProCrew -->--}}
    <div class="container" id="latest-ads">
                ...
                <div class="col-xl-12 box-title no-border">
                    <div class="inner">
                        <h2 style="display: block;">
                            ...
                            {{--<i class="icon-plus"></i> {{ t('View more') }}--}}
                            {{--</a>--}}
                            <div class="pull-right col-xs-6 text-left listing-view-action">
...
//                    dd($posts);
                    ...
                    <div class="item-list">
                        @if (isset($package) and !empty($package))
                            @if ($package->ribbon != '')
                                <div class="cornerRibbons {{ $package->ribbon }}"><a
                                ...
                                <div class="ads-details">
                                    ...
                                    <span class="info-row">
										...
										<a href="{!! qsurl(config('app.locale').'/'.trans('routes.v-search', ['countryCode' => config('country.icode')]), array_merge(Request::except(['l', 'location']), ['l'=>$post->city_id])) !!}"
                                           class="info-link">{{ $city->name }}</a> {{ (isset($post->distance)) ? '- ' . round(lengthPrecision($post->distance), 2) . unitOfLength() : '' }}
										</span>
									</span>
                                </div>
...
{{--                                    @endif--}}
                    ...
                    <div id="remove-row">
                        <button id="btn-more" data-id="{{ $post->id }}"
                                class="nounderline mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                            <i class="fa fa-plus-circle"></i> {{ t('View more') }}</button>
                    </div>
                </div>
    ...
    {{--<!-- Start - Ads Section - ProCrew -->--}}
    {{--</div>--}}
    {{--<div class="col-md-2 col-sm-12 col-xs-12 text-right ad">--}}
    {{--<img src="images/ad-4.jpg"class="ad-md">--}}
    {{--<img src="https://s0.2mdn.net/6232239/Cart-Abandoners-728x90.jpg" class="ad-sm">--}}
    {{--</div>--}}
    {{--</div>--}}
    ...
    <script>
        ...
        $(document).ready(function () {
            $(document).on('click', '#btn-more', function () {
                var id = $(this).data('id');
                $("#btn-more").html(lang['loading']);

                $.ajax({
                    url: '{{ url("post/loaddata") }}',
                    method: "POST",
                    data: {id: id, _token: "{{csrf_token()}}", type_view: document.cookie},
                    dataType: "text",
