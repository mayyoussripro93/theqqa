@if (isset($categoriesOptions) and isset($categoriesOptions['type_of_display']))
    ...
    <div class="container animated fadeInUp" id="cat-search">
        <div class="col-xl-12 content-box layout-section animated fadeInUp">
            <div class="row row-featured row-featured-category justify-content-md-center justify-content-sm-center">
                <div class="col-xl-12 box-title no-border">
                    <div class="inner">
                        <h2>
                            ...
                            <a href="{{ lurl(trans('routes.v-sitemap', $attr), $attr) }}"
                        ...
                        @foreach($categories as $key => $cat)
                            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 f-category">
                                ...
                                <a href="{{ lurl(trans('routes.v-search-cat', $attr), $attr) }}">
                                    <img src="{{ \Storage::url($cat->picture) . getPictureVersion() }}"
