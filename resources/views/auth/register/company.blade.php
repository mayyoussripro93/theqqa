            ...
            <div class="row">
                ...
                <div class="col-md-8 page-content">
                    <div class="inner-box">
                        ...
                        <div class="row mt-5">
                            <div class="col-xl-12">
                                <form id="signupForm" class="form-horizontal" method="POST" action="{{ lurl('register/Company') }} " enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    <fieldset>
                                        <!-- company -->
                                        <?php $CompanyError = (isset($errors) and $errors->has('company')) ? ' is-invalid' : ''; ?>
                                        <div  class="form-group row required">
                                            <label class="col-md-4 col-form-label{{ $CompanyError }}">{{ t('Company type') }} <sup>*</sup></label>
                                            <div class="col-md-6">
                                                <select name="company" id="companyId" class="form-control selecter{{ $CompanyError }}">
                                                    <option value="3"> {{ t('Car Inspection Company') }} </option>
                                                    <option value="4"> {{ t('Car Maintenance Company') }} </option>
                                                    <option value="5"> {{ t('Car Shipping Company') }} </option>
                                                    <option value="6"> {{ t('Exhibition') }} </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <!-- password -->
                                        ...
                                        <div class="form-group row required">
                                            <label class="col-md-4 col-form-label" for="password">{{ t('file') }} <sup>*</sup></label>
                                            <div class="col-md-6">
                                                <input id="file"  multiple="multiple" name="file[]" type="file" class="form-control{{ $fileError }}"
                                                       placeholder="{{ t('file') }}">
                                            </div>
                                        </div>
                                ...
                                <a href="{{ lurl('register/Company') }}" class="btn"><i class="icon-googleplus-rect"></i> {!! t('Company register') !!}</a>
                            </div>
