...
<br>Phone number: :phone',
    ...
    'Your account will be active after admin approve on your Account.' => 'Your account will be active after admin approve on your Account.',
...
<br><br>If you have any doubt about the seriousness of an advertiser, please contact us immediately. We can then neutralize as quickly as possible and prevent someone less informed do become the victim.',
    ...
    'payment_sent_content_2_deposit' =>  'We have recieved a deposit on the purchase of "<a href=":postUrl">:title</a>", the balance being payable late',
    'Booking will be confirmed within 48 hours via email' => 'Booking will be confirmed within 48 hours via email',
    'If not confirmed, we will contact you to refund the payment' => 'If not confirmed, we will contact you to refund the payment',
    'payment_sent__deposit_3' => 'THE PAYMENT DETAILS
<br><strong>Reason of the payment:</strong> Ad #:adId - :packageName
<br><strong>The Amount Paid:</strong> :amount :currency
<br><strong>Total Price:</strong> :totalamount :currency
<br><strong>Payment Method:</strong> :paymentMethodName',
    'payment_sent_content_user'         => 'We have received your payment for ' ,
	// payment_notification
    'payment_notification_title'     => 'New payment has been sent',
    'payment_notification_title_deposit'     => 'New payment has been sent for deposit car',
    ...
    'payment_notification_content_deposit_car_2' => 'The user :advertiserName has just paid a package for deposit car  "<a href=":postUrl">:title</a>".',
    'payment_notification_content_3' => 'THE PAYMENT DETAILS
<br><strong>Reason of the payment:</strong> Ad #:adId - :packageName
<br><strong>Amount:</strong> :amount :currency
<br><strong>Payment Method:</strong> :paymentMethodName',
    'payment_notification_content_deposit_car_3' => 'THE PAYMENT DETAILS
<br><strong>Reason of the payment:</strong> Ad #:adId - :packageName
<br><strong>The Amount Paid:</strong> :amount :currency
<br><strong>Total Price:</strong> :totalamount :currency
<br><strong>Payment Method:</strong> :paymentMethodName',
...
<br><strong>Payment Method:</strong> :paymentMethodName',
    ...
    'payment_sent_for_booking_title'             => 'Booking Service!',
    'payment_sent_for_booking_content_1'         => 'Hello,',
    'payment_sent_for_booking_content_2'         => 'we received payment for booking this ad "<a href=":postUrl">:title</a>" has been approved.',
    'payment_sent_for_booking_content_3'         => 'شكرًا لك!',
    'payment_sent_for_booking_content_2_deposit' =>  'We have received a deposit from your car reservation "<a href=":postUrl">:title</a>" The remaining amount will be paid later',
    'payment_sent_for_booking_content_2_deposit_2' => 'Please contact with theqqa admins and clint for more information',

    'payment_sent_for_booking_deposit_3' => '<strong style="color: #907624;"> THE PAYMENT DETAILS</strong>
<br><strong>Reason of the payment:</strong> Ad #:adId - :packageName
<br><strong>The Amount Paid:</strong> :amount :currency
<br><strong>Total Price:</strong> :totalamount :currency
<br><strong>Payment Method:</strong> :paymentMethodName',
