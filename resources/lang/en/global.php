...
return [
    ...
    |
    */
    'Payment de'=>'THE PAYMENT DETAILS
...
<br><strong>Payment Method:</strong> :paymentMethodName',
    'postUrl' => 'Post Url',
    'You will be assured of booking and send confirmation by your email and by massages on Theqqa'=>'You will be assured of booking and send confirmation by your email and by massages on Theqqa',
       'Paytabs' =>'Paytabs',
       'we will send confirmation of this servce by your email and by massages on Theqqa'=>'we will send confirmation of this servce by your email and by massages on Theqqa',
    ...
    'origin_address_detail' => 'Origin address in detail',
    ...
    'Do have anything to sell or rent?' => 'Do have new car or used car to sell ?',
    'Sell your products and services online FOR FREE. It\'s easier than you think !' => 'Sell your Car and services online FOR FREE. It\'s easier than you think !',
    ...
    'Back to Results' => 'Back to Previous Page',
    ':type ad' => ':type ad',
    ...
    'Post not found' => 'The ad was deleted after the condition period expired',
    ...
    'Car Inspection Company' => 'Car Inspection Company',
    'Car Maintenance Company' => 'Car Maintenance Company',
    'Car Shipping Company' => 'Car Shipping Company',
    'Exhibition' => 'Exhibition',
    'file' => 'file',
    'user' => 'Register User',
    'Company' => 'Company',
    'Register type' => 'Register Type',
    'mogaz service ' => 'Mogaz Service',
    'easy transfer service' => 'Easy Transfer Service',
    'car data' => 'Car Data',
    'user data' => 'User Data',
    'Owner' => 'Owner',
    'User' => 'User',
    ...
    'Batteries shop' => 'Batteries shop',
    'shop type' => 'Shop Type',
    'id number' => 'Id Number',
    'car register' => 'This car registered in Theqqa?',
    'yes' => 'yes',
    'no' => 'no',
    'car url' => 'Please enter the car URL at Theqqa website',
    'services_title' => 'Our Services',
    'ownership_title' => 'Ownership Transfer',
    'ownership_desc' => 'We provide a service to facilitate transferring car ownership from seller to buyer.',
    'mogaz_title' => 'Inquiry about car',
    'mogaz_desc' => 'We offer you a service to inquire about any car whether it is on our website or not.',
    'checking_title' => 'Car Inspection',
    'checking_desc' => 'You can inspect and test any vehicle displayed on our website before purchasing it.',
    'shipping_title' => 'Car Shipping',
    'shipping_desc' => 'A service can be ordered to ship your car to any place inside the Kingdom of Saudi Arabia.',
    'maintenance_title' => 'Car Maintenance',
    'maintenance_desc' => 'You can ask for this service to fix your car at any of our registered maintenance centers.',
    'services_title_car' => 'Services for this car',
    ...
    'shipping_place' => 'Original Location',
    'car_place' => 'Car Receipt Place',
    'cost_service' => 'The cost of this service from Theqqa 50$',
    'Shipping_center' => 'Shipping center from Theqqa',
    'maintenance_center' => 'Maintenance center from Theqqa',
    'The Image type must be in type (jpeg,jpg,png,gif ).' => 'The Image type must be in type (jpeg,jpg,png,gif ).',
    ...
    "Please provide a copy of the owner's or agent's identity and the copy of the Commercial Record ." => "Please provide a copy of the owner's or agent's identity and the copy of the Commercial Record .",
    'car_searce' => 'Enter the name of the category you want to search for or brand the car',
    'url_save' => 'Copy the link',
    'Booking the car' => 'Booking the car',
    'booking_desc' =>'You can book your car by paying 2.5% of the value of the car',
    'subladmin1' => 'Select Branches',
    'checking_time' => 'Checking Time',
    'shipping_location' => 'Specify your shipping locations (from / to)',
    'maintenance_location' => 'Choose the nearest maintenance center',
    'checking_location' => 'Choose the nearest place for checking the car',
    'appointment' => 'Checking Time can not be selected 6 hours from now',
    'sadad' => "Payment by Sadad",
    'paybal' => "Payment by Paybal",
    'visa' => "Payment by Visa",
    'service' => 'This service is available only for advertisements added by exhibitions',
    'address' => "Enter address in detail",
    'service_name' => 'Service Name',
    'Theqqa url' => 'Please enter the car URL at Theqqa website',
    'car_out' => "This car is not displayed on Theqqa website",
    'car_in' => "All data of this car on Theqqa website",
    'shipping_place_to' => 'Shipping Destination',
    'address_to' => 'Enter destination address in detail',
    'address_to_ditail' =>'Destination address in detail ',
    'from' => 'from',
    'to' => 'to',
    'The car will be booked with a payment of 2.5% of the value of the car.' =>'Deposit of booking car',
    'checking_date' =>'Checking Date',
    'time_appointment'   => 'You can not select a past date for Checking',
    'From' => 'From',
    'To' => 'To',
    "A Copy of the owner's or agent's identity and the copy of the Commercial Record" => "A Copy of the owner's or agent's identity and the copy of the Commercial Record ",
    'purchaser name' => 'Purchaser Name',
    'seller name' => 'Seller Name',
    'Kilometers_car' => "Kilometers",
    'purchaser id image' => 'Purchaser Id Image',
    'seller id image' => 'Seller Id Image',
    'car Pictures' => 'Car Pictures',
    'Both parties must attend the signing' => 'Both parties must attend to sign',
    'Choose the exhibition where the Ownership will take place' => 'Choose the exhibition where the transfer will take place',
    'Kilometers_value' =>'Kilometers ',
    'car price' =>'Car Price',
    'exhibitions'=>'Exhibitions',
    'car_Pictures_span' =>'Please upload 2 images for the car',
    'car_Pictures_span_4' => 'Please upload 4 car images from four directions',
    'maintenance_place' => 'It displayed Maintenance center  near from the place of the car ',
    'maintenance_choose' => 'Choose from Maintenance centers',
    'purchaser_data' => 'Purchaser Data',
    'seller_data' => 'Seller Data',
    'nearest_place' => 'Choose the nearest place to you',
    'available_exhibitions' => 'Available Exhibitions',
    'from_location' => 'Original Car Location (From)',
    'to_location' => 'Shipping Destination (To)',
    'exhibitions_location' => 'Exhibitions Location',
    'click_enlarge' => 'Click to enlarge the image',
    'doc_pic' => 'Your Documents',
    'service_name' => 'Service Name',
    'Receiver\'s Name' => 'Sender\'s Name',
    'Receiver\'s Email' => 'Sender\'s Email',
    'Receiver\'s Phone' => 'Sender\'s Phone',
    'exhibition_name' => 'Selected Exhibition',
    'car-in' =>"This car is displayed on Theqqa website",
    'ad_code' =>"Ad Code",
    'car_exist' =>"Car Exists?",
    'Car Booking Deposit' => 'Car Booking Deposit',
    'Price of the car in Theqqa website' => 'Car price in Theqqa website',
    'choose_payment_method' =>"Payment Method",
    'guarantee_value' =>"Guarantee Value",
    'total_value' =>"Total",
    'theqqa url' =>'Select the car from Theqqa website',
    'bank_transfer' =>'Bank transfer',
    'You will be assured of bank transfer and confirmation of your booking by your email and by massages on Theqqa' => 'You will be assured of bank transfer and confirmation of your booking by massages on Theqqa',
    'estimation title' => 'Estimate Service',
    'estimation_desc' => 'You can request a service to estimate your car value',
    'premium_service' => 'Premium Service',
    'premium_service_desc' => 'We offer you a range of premium services (paid) to facilitate all the car related transactions whether displayed on our website or not.',
    'upload_bank_transfer' => 'Upload bank transfer doc',
    'ownership_exhib' => 'exhibition where the ownership transfer will take place',
    'First Owner\'s Name' => "First Owner's Name",
    'Middle Owner\'s Name' => "Middle Owner's Name",
    'Last owner\'s name' => "Last owner's name",
    ...
    'car_Pictures_span_5' => 'Please upload 4 car images from four directions and Picture of an interior car',
    'Add an ad on a Theqqa site' =>"Add an ad on a Theqqa site",
    "To Request This Service" =>"To Request This Service",
    "let's start" =>'start',
    "For_service_alert_2"=>"<p style='text-align: left; font-size: 16px;'>You can now request this service from Theqqa website through bank transfer on the following account:<br><br><span style='font-size: 14px;'><strong style='font-weight: bold;'>Al Rajhi Bank</strong><br>Theqqa Electronic Marketing Account<br><strong style='font-weight: bold;'>current account:</strong> 646608010000412<br><strong style='font-weight: bold;'>Iban:</strong> SA61 8000 0646 6080 1000 0412</span><br><br>Once you've made a bank transfer, please attach a bank transfer image in the appropriate field when creating a new unique ad.<br> Also you can use paytabs .PayTabs offers a variety of payment options such as American Express, MasterCard, Visa, mada, STC Pay, OmanNet and more.</p>",
    "For_service_alert"=>"<p style='text-align: left; font-size: 16px;'>You can now request this service from Theqqa website through bank transfer on the following account:<br><br><span style='font-size: 14px;'><strong style='font-weight: bold;'>Al Rajhi Bank</strong><br>Theqqa Electronic Marketing Account<br><strong style='font-weight: bold;'>current account:</strong> 646608010000412<br><strong style='font-weight: bold;'>Iban:</strong> SA61 8000 0646 6080 1000 0412</span><br><br>Once you've made a bank transfer, please attach a bank transfer image in the appropriate field when creating this service.<br> Also you can use paytabs .PayTabs offers a variety of payment options such as American Express, MasterCard, Visa, mada, STC Pay, OmanNet and more.</p>",
    'You will be contacted by email or messages through Theqqa website' =>"You will be contacted by email or messages through Theqqa website",
    "Featured Ad (Paid)"=>"Featured Ad (Paid)",
    "You can now show your ad on the list of featured ads on Theqqa by wire transfer on the following account:" =>"You can now show your ad on the list of featured ads on Theqqa by wire transfer on the following account:",
    'Required Documents' =>"Required Documents",
    "Once you've made a bank transfer, please attach a bank transfer image in the appropriate field when creating a new unique ad."=>"Once you've made a bank transfer, please attach a bank transfer image in the appropriate field when creating a new unique ad.<br> Also you can use paytabs .PayTabs offers a variety of payment options such as American Express, MasterCard, Visa, mada, STC Pay, OmanNet and more.",
    'Now you can publish your ad for free or special on Theqqa' =>"Now you can publish your ad for free or special on Theqqa",
    'Required Documents In Case Of Special Advertisements' =>"Required Documents In Case Of Special Advertisements",
    'Now you can publish your ad for free or special on Theqqa .There are no documents required in the case of free advertising' =>"Now you can publish your ad for free or special on Theqqa .There are no documents required in the case of free advertising",
];
