...
return [
	...
	*/
	...
	'attributes' => [
        ...
        'car_url' =>'Choose Car from theqqa',
        'checking_place' =>'Checking Place',
        'shipping_id' =>'Checking Place',
        'maintenance_id' =>'Maintenance Place',
        'checking_time' =>'Checking Time',
        'shipping_place_to' => 'Destination',
        'address_to' => ' the address of the destination in detail ',
        'purchaser_name' => 'Purchaser Name',
        'seller_name' => 'Seller Name',
        'Kilometers_car' => "Kilometers",
        'purchaser_id_image' => 'Purchaser Id Image',
        'seller_id_image' => 'Seller Id Image',
        'Car_Pictures' => 'Car Pictures',
        'Kilometers_id' =>'Kilometers ',
        'car_price' =>'Car Price',
        'exhibitions'=>'Exhibitions',
        'exhibitions_place'=>'Exhibitions Place',
        'subladmin1' => 'Select Branches',
        'id_number_owner' =>'Owner ID Number',
        'bank_transfer_in' => 'Image for Bank transfer',
        'first_owner_name' => "First Owner's Name",
        'middle_owner_name' => "Middle Owner's Name",
        'last_owner_name' => "Last owner's name",
        'car_type'=>'Car Type',
