...
class Field extends BaseModel
{
    ...
    */
    ...
    {
        return $this->belongsTo(Category::class, 'category_id', 'translation_of')->where('translation_lang', config('app.locale')!=null?config('app.locale'):'Ar');
    }
    
    public function options()
    {
        return $this->hasMany(FieldOption::class, 'field_id', 'translation_of')->where('translation_lang', config('app.locale')!=null?config('app.locale'):'Ar')
			->orderBy('lft', 'ASC')
			->orderBy('value', 'ASC');
    }
