...
//                'data' =>  $data ,
                ...
                'user' => $user ,
                'userPhoto' => $userPhoto,
                'commentsAreDisabledByUser' =>$commentsAreDisabledByUser,
    ...
    public function lovepost($postId)
    {
        ...
        foreach($customFields as $field) {
            ...
            $lovePost= \App\Models\SavedPost::where('user_id', auth()->user()->id)->where('post_id', $post->id)->count() > 0;
            return response()->json([
                'status' => 'success',
                'data' =>  $data ,
                'post' => $post ,
	...
	public function sendMessage($postId, SendMessageRequest $request)
	{
        ...
        return response()->json([
            'status' => 'success',
            'data' =>  t("Your message has sent successfully to :contact_name.", ['contact_name' => $post->contact_name]),
