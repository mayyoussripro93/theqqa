	...
	public function setup()
	{
		...
		*/
        ...
        $this->xPanel->addColumn([
            ...
            'type'          => 'model_function',
            'function_name' => 'getPriceNameHtml',
        ]);
        $this->xPanel->addColumn([
            'name'  => 'pt_transaction_id',
            'label' => trans("admin::messages.pt_transaction_id"),

        ]);
        $this->xPanel->addColumn([
            'name'  => 'pt_invoice_id',
            'label' => trans("admin::messages.pt_invoice_id"),
		...
		$this->xPanel->addColumn([
			...
			'type'          => 'model_function',
			'function_name' => 'getVerifiedBookingEmailHtml',
		]);
